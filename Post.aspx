<%@ Page Title="" Language="C#" MasterPageFile="~/Master Pages/MasterPage.master" AutoEventWireup="true" CodeFile="Post.aspx.cs" Inherits="Post" %>
    ...
    <section class="contact-section" style="background:#ffffff">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h2 class="contact-title" style="margin-top:53px">Personal Details</h2>
                ...
                --%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                   Profile Photo
                                    <asp:FileUpload ID="FileUpload1" runat="server" class="form-control valid" AllowMultiple="false" />
                                    ...
                                    <asp:Image ID="profilephoto" runat="server"  Visible="false" CssClass="img img-thumbnail" Height="100" Width="100"/>
                                    <br />
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                   Other Photos(optional)
                                    <asp:FileUpload ID="FileUpload2" runat="server" class="form-control valid" AllowMultiple="true" />
                                    ...
                                    <asp:Label ID="Label1" runat="server" CssClass="alert alert-danger embed-responsive" Text="" ForeColor="Red"></asp:Label>
                        ...
                        <div class="form-group mt-3">
                            <asp:Button ID="btnsubmit" runat="server" class="button button-contactForm boxed-btn" ValidationGroup="B" Text="Submit" OnClick="btnsubmit_Click" />
