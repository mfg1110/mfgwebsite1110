...
public partial class signup : System.Web.UI.Page
{
    ...
    {
        flaguserexist = Registrationobj.Userexistornot(txtuserid.Text);
        if (flaguserexist == "true")
        {
            lblerror.Visible = true;
            lblerror.Text = " Email ID already exist.";
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ValidatePage())
            {
                ...
                Registrationobj.Register_Data(txtfname.Text, txtlname.Text, txtuserid.Text, "", txtpwd.Text,"true", DateTime.Now, DateTime.Now);
                string body = this.PopulateBody(txtfname.Text, txtlname.Text, activationCode);
